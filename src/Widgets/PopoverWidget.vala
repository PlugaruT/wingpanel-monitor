...
namespace WingpanelMonitor {
    public class PopoverWidget : Gtk.Grid {
        ...
        public void update_network (int upload, int download) {
            network_down.label_value = Utils.format_net_speed (download, true, settings.get_boolean ("show-bits"));
            network_up.label_value = Utils.format_net_speed (upload, true, settings.get_boolean ("show-bits"));
        }
    }
}
